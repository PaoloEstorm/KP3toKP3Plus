...
**Note:** If the procedure completed successfully, your device has effectively become a KP3+. So, if you plan to use the Editor application or as a MIDI controller, you'll need the Drivers and the "KP3+ Editor", both downloadable form the [official support page](https://www.korg.com/us/support/download/product/0/124/).
